  ...
  return (
    <div>
      ...
      <section className="relative w-full min-h-screen bg-gradient-to-r from-purple-900 via-pink-700 to-purple-800 text-white overflow-hidden">
        ...
        />
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-10 md:px-6 md:py-12 items-center">
          {/* Title for Mobile */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-center text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.6)] tracking-wide md:hidden">
            КИБЕР ХОТ
          </h1>
          {/* Left Column (Image and Description) */}
          <div className="space-y-4 md:pt-5 order-2 md:order-1">
            <p className="wixui-rich-text__text text-4xl font-extrabold text-blue-400 md:text-5xl lg:text-[69px] hidden md:block">
              Тэмцээн
            </p>
          ...
          {/* Right Column (Title, Details, Button) */}
          <div className="flex flex-col justify-center items-center space-y-4 text-center order-1 md:order-2">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-center text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.6)] tracking-wide hidden md:block">
              КИБЕР ХОТ
            </h1>
            <div className="max-w-2xl mx-auto shadow-lg rounded-2xl p-6 space-y-4 text-sm backdrop-blur-md">
              ...
              <ul className="text-start">
                ...
                <li>
                  <span className="font-semibold text-blue-900">Ангилал:</span>{" "}
                  10-15
                </li>
                <li>
                  <span className="font-semibold text-blue-900">Баг:</span> 2
                  сурагч, 1 багш
                </li>
                <li>
                  <span className="font-semibold text-blue-900">
                ...
                <li>
                  <span className="font-semibold text-blue-900">Шагнал:</span>{" "}
                  Тэмцээний эхний 3 баг{" "}
      ...
      <section className="relative w-full min-h-screen bg-gradient-to-r from-purple-900 via-pink-700 to-purple-800 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-10 md:px-6 md:py-12 items-center">
          {/* Title for Mobile */}
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-center text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.6)] tracking-wide md:hidden">
            ГЕОМЕТРИЙН ОЙ
          </h1>
          {/* Right Column (Image and Description) */}
          <div className="space-y-4 md:pt-5 order-2 md:order-2">
            <div className="bg-gray-100/70 p-4 shadow-lg backdrop-blur-sm transition-opacity duration-700 ease-in-out hover:opacity-90">
              <Image
              ...
              <div className="mt-4 flex gap-2 justify-between">
                <div className="mx-auto border rounded overflow-hidden w-52 h-16 text-xs">
                  ...
                  <div className="grid grid-cols-2 bg-gray-100 text-xs">
                    ...
                    <div className="p-1 text-gray-700 w-32">
                      2 сурагч, 1 багш
                    </div>
                  </div>
                </div>
          ...
          {/* Left Column (Title, Details, Button) */}
          <div className="flex flex-col justify-center items-center space-y-4 text-center order-1 md:order-1">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-center text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.6)] tracking-wide hidden md:block">
              ГЕОМЕТРИЙН ОЙ
            </h1>
            <div className="max-w-2xl mx-auto shadow-lg rounded-2xl p-6 space-y-4 text-sm backdrop-blur-md">
              <h2 className="text-sm font-bold text-white-800 text-start">
              ...
              <ul className="text-start">
                ...
                <div>
                  ...
                  <li>
                    <span className="font-semibold">
                      Геометрийн ой: Тэмцээний танилцуулга видео:
                    </span>
                  </li>
                  <span className="font-semibold">
                    <a
      ...
      {/* Section 3: ТЭНГЭРИЙН АДАЛ ЯВДАЛ */}
      <section className="relative w-full min-h-screen bg-gradient-to-r from-purple-900 via-pink-700 to-purple-800 text-white overflow-hidden">
        <Image
          src="/image/sky.avif"
          alt="cyber city"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-10 md:px-6 md:py-12 items-center">
          {/* Title for Mobile */}
          <h1 className="text-4xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-center text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.6)] tracking-wide md:hidden">
            ...
            <div className="bg-gray-100/70 p-4 shadow-lg backdrop-blur-sm transition-opacity duration-700 ease-in-out hover:opacity-90">
              ...
              <div className="mt-4 flex gap-2 justify-between">
                <div className="mx-auto border rounded overflow-hidden w-52 h-16 text-xs">
                  <div className="grid grid-cols-2 text-white font-bold text-xs text-start">
                    <div className="p-1 border-r bg-purple-400">АНГИЛАЛ</div>
                    <div className="p-1 text-gray-700">8-12 нас, 13-17 нас</div>
                  </div>
                  <div className="grid grid-cols-2 bg-gray-100 text-xs">
                    <div className="p-1 border-r font-semibold bg-purple-400">
                      БАГ
          ...
          {/* Right Column (Title, Details, Button) */}
          <div className="flex flex-col justify-center items-center space-y-4 text-center order-1 md:order-2">
            <h1 className="text-4xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-center text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.6)] tracking-wide hidden md:block">
              ТЭНГЭРИЙН АДАЛ ЯВДАЛ
            </h1>
            <div className="mb-4 max-w-2xl mx-auto shadow-lg rounded-2xl p-6 space-y-4 text-sm backdrop-blur-md">
              <h2 className="text-sm font-bold text-white-800 text-start">
                ENJOY AI улсын аварга шалгаруулах Робот кодчилолын тэмцээн:
              </h2>
              <ul className="text-start">
                ...
                <li>
                  <span className="font-semibold text-blue-900">Баг:</span> 1
                  сурагч, 1 багш
                </li>
                <li>
                  <span className="font-semibold text-blue-900">
                ...
                <div>
                  ...
                  <li>
                    <span className="font-semibold">
                      Дрон Тэмцээний танилцуулга виде:
                    </span>
                  </li>
                  <span className="font-semibold">
                    <a
